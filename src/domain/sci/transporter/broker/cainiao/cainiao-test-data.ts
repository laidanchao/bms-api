...
// 模拟平台请求：使用client进行测试
const basicConfig = {
  shipmentUrl: 'http://prelink.cainiao.com/gateway/link.do',
  productCode: '72007',
  // accountInfo: {
  //   token: 'ToxZn239217Sus8Y4ya1tL0GdQ10C607',
  //   cainiaoIdentity: '2215602327889',
  //   logistic_provider_id: 'colicoli',
  // },
  accountInfo: {
    token: '02T0IsUsEK43wtMxZM1mkX10309Bjz9g',
    cainiaoIdentity: '2215966119039',
    logistic_provider_id: '198c948de92dc0052e5eb6a26d9be027',
  },
  labelFormat: {
    labelType: 'pdf',
    value: 'THE',
...
export { basicConfig, buildShipment, orderParams, traceParams };
